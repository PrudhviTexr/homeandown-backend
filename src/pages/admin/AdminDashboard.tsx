  ...
  const renderContent = () => {
    ...
    const bookingColumns = [
      ...
      { key: 'property', header: 'Property', render: (booking: Booking) => {
        ...
        return property ? property.title : booking.property_id;
      }},
      { key: 'buyer', header: 'Buyer', render: (booking: Booking) => {
      ...
      { key: 'agent', header: 'Agent', render: (booking: Booking) => {
        if (!booking.agent_id) return 'Not Assigned';
        const agent = users.find(u => u.id === booking.agent_id);
        return agent ? `${agent.first_name} ${agent.last_name}` : booking.agent_id;
      }},
      ...
      case 'property-assignments':
        return <PropertyAssignmentManager onRefresh={fetchAllData} />;
              ...
              case 'document-viewer':
                return <DocumentViewer onRefresh={fetchAllData} />;

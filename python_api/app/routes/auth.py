    ...
    try:
        ...
        try:
            ...
            try:
                ...
                # Don't fail the signup if role initialization fails
        ...
        if hasattr(payload, 'documents') and payload.documents:
            try:
                for doc in payload.documents:
                    ...
                    try:
                        ...
                        print(f"[AUTH] Document {doc_id} associated to user {user_id}")
                    except Exception as e:
                        print(f"[AUTH] Failed to associate document {doc_id} to user {user_id}: {e}")
